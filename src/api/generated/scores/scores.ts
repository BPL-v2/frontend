...
export const getGetLatestScoresForEventBaseQueryKey = (eventId: number) => {
  return [`/events/${eventId}/scores/latest`] as const;
};

export const getGetLatestScoresForEventBaseQueryOptions = <
  TData = Awaited<ReturnType<typeof getLatestScoresForEventBase>>,
  TError = unknown,
>(
  eventId: number,
  options?: {
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetLatestScoresForEventBaseQueryKey(eventId);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getLatestScoresForEventBase>>
  > = ({ signal }) =>
    getLatestScoresForEventBase(eventId, { signal, ...requestOptions });
...
export type GetLatestScoresForEventBaseQueryResult = NonNullable<
  Awaited<ReturnType<typeof getLatestScoresForEventBase>>
>;
export type GetLatestScoresForEventBaseQueryError = unknown;

export function useGetLatestScoresForEventBase<
  TData = Awaited<ReturnType<typeof getLatestScoresForEventBase>>,
  TError = unknown,
>(
  eventId: number,
...
>(
  ...
  const queryOptions = getGetLatestScoresForEventBaseQueryOptions(
    eventId,
    options,
  );
...
export const getSimpleScoreWebSocketBaseQueryKey = (eventId: number) => {
  return [`/events/${eventId}/scores/simple/ws`] as const;
};

export const getSimpleScoreWebSocketBaseQueryOptions = <
  TData = Awaited<ReturnType<typeof simpleScoreWebSocketBase>>,
  TError = unknown,
>(
  eventId: number,
  options?: {
  ...
  const queryKey =
    queryOptions?.queryKey ?? getSimpleScoreWebSocketBaseQueryKey(eventId);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof simpleScoreWebSocketBase>>
  > = ({ signal }) =>
    simpleScoreWebSocketBase(eventId, { signal, ...requestOptions });
...
export type SimpleScoreWebSocketBaseQueryResult = NonNullable<
  Awaited<ReturnType<typeof simpleScoreWebSocketBase>>
>;
export type SimpleScoreWebSocketBaseQueryError = unknown;

export function useSimpleScoreWebSocketBase<
  TData = Awaited<ReturnType<typeof simpleScoreWebSocketBase>>,
  TError = unknown,
>(
  eventId: number,
...
>(
  ...
  const queryOptions = getSimpleScoreWebSocketBaseQueryOptions(
    eventId,
    options,
  );
...
export const getScoreWebSocketBaseQueryKey = (eventId: number) => {
  return [`/events/${eventId}/scores/ws`] as const;
};

export const getScoreWebSocketBaseQueryOptions = <
  TData = Awaited<ReturnType<typeof scoreWebSocketBase>>,
  TError = unknown,
>(
  eventId: number,
  options?: {
  ...
  const queryKey =
    queryOptions?.queryKey ?? getScoreWebSocketBaseQueryKey(eventId);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof scoreWebSocketBase>>
  > = ({ signal }) =>
    scoreWebSocketBase(eventId, { signal, ...requestOptions });
...
export type ScoreWebSocketBaseQueryResult = NonNullable<
  Awaited<ReturnType<typeof scoreWebSocketBase>>
>;
export type ScoreWebSocketBaseQueryError = unknown;

export function useScoreWebSocketBase<
  TData = Awaited<ReturnType<typeof scoreWebSocketBase>>,
  TError = unknown,
>(
  eventId: number,
