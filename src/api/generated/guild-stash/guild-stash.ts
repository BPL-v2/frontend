...
export const getGetGuildsBaseQueryKey = (eventId: number) => {
  return [`/${eventId}/guilds`] as const;
};

export const getGetGuildsBaseQueryOptions = <
  TData = Awaited<ReturnType<typeof getGuildsBase>>,
  TError = unknown,
>(
  eventId: number,
  options?: {
    query?: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof getGuildsBase>>, TError, TData>
    >;
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getGuildsBase>>> = ({
    signal,
  }) => getGuildsBase(eventId, { signal, ...requestOptions });
...
export type GetGuildsBaseQueryResult = NonNullable<
  Awaited<ReturnType<typeof getGuildsBase>>
>;
export type GetGuildsBaseQueryError = unknown;

export function useGetGuildsBase<
  TData = Awaited<ReturnType<typeof getGuildsBase>>,
  TError = unknown,
>(
  eventId: number,
...
export type SaveGuildBaseMutationResult = NonNullable<
  Awaited<ReturnType<typeof saveGuildBase>>
>;
...
export const getGetLogEntriesForGuildBaseUrl = (
  ...
  return stringifiedParams.length > 0
    ? `/${eventId}/guilds/${guildId}/stash-history?${stringifiedParams}`
...
export const getGetLogEntriesForGuildBaseQueryKey = (
  eventId: number,
  guildId: number,
  params?: GetLogEntriesForGuildBaseParams,
) => {
...
export const getGetLogEntriesForGuildBaseQueryOptions = <
  TData = Awaited<ReturnType<typeof getLogEntriesForGuildBase>>,
  TError = unknown,
>(
  eventId: number,
  guildId: number,
  ...
  const queryKey =
    ...
    getGetLogEntriesForGuildBaseQueryKey(eventId, guildId, params);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getLogEntriesForGuildBase>>
  > = ({ signal }) =>
    getLogEntriesForGuildBase(eventId, guildId, params, {
      signal,
      ...requestOptions,
    });
...
export type GetLogEntriesForGuildBaseQueryResult = NonNullable<
  Awaited<ReturnType<typeof getLogEntriesForGuildBase>>
>;
export type GetLogEntriesForGuildBaseQueryError = unknown;

export function useGetLogEntriesForGuildBase<
  TData = Awaited<ReturnType<typeof getLogEntriesForGuildBase>>,
  TError = unknown,
>(
  eventId: number,
  guildId: number,
  params: undefined | GetLogEntriesForGuildBaseParams,
  options: {
    query: Partial<
      UseQueryOptions<
        Awaited<ReturnType<typeof getLogEntriesForGuildBase>>,
...
>(
  ...
  const queryOptions = getGetLogEntriesForGuildBaseQueryOptions(
    eventId,
    guildId,
    params,
    options,
...
export type AddGuildstashHistoryBaseMutationResult = NonNullable<
  Awaited<ReturnType<typeof addGuildstashHistoryBase>>
>;
...
> => {
  return useMutation(
    getAddGuildstashHistoryBaseMutationOptions(options),
    queryClient,
  );
};
/**
...
export const getGetLatestTimestampForUserBaseQueryKey = (
  eventId: number,
  guildId: number,
) => {
  return [
...
export const getGetLatestTimestampForUserBaseQueryOptions = <
  TData = Awaited<ReturnType<typeof getLatestTimestampForUserBase>>,
  TError = unknown,
>(
  eventId: number,
  guildId: number,
  ...
  const queryKey =
    queryOptions?.queryKey ??
    getGetLatestTimestampForUserBaseQueryKey(eventId, guildId);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getLatestTimestampForUserBase>>
  > = ({ signal }) =>
    getLatestTimestampForUserBase(eventId, guildId, {
      signal,
      ...requestOptions,
    });
...
export type GetLatestTimestampForUserBaseQueryResult = NonNullable<
  Awaited<ReturnType<typeof getLatestTimestampForUserBase>>
>;
export type GetLatestTimestampForUserBaseQueryError = unknown;

export function useGetLatestTimestampForUserBase<
  TData = Awaited<ReturnType<typeof getLatestTimestampForUserBase>>,
  TError = unknown,
>(
  eventId: number,
...
>(
  ...
  const queryOptions = getGetLatestTimestampForUserBaseQueryOptions(
    eventId,
    guildId,
    options,
  );
...
export const getGetGuildStashForUserBaseQueryKey = (
  eventId: number,
  teamId: number,
) => {
  return [`/${eventId}/teams/${teamId}/guild-stash`] as const;
};

export const getGetGuildStashForUserBaseQueryOptions = <
  TData = Awaited<ReturnType<typeof getGuildStashForUserBase>>,
  TError = unknown,
>(
  eventId: number,
  teamId: number,
  ...
  const queryKey =
    queryOptions?.queryKey ??
    getGetGuildStashForUserBaseQueryKey(eventId, teamId);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getGuildStashForUserBase>>
  > = ({ signal }) =>
    getGuildStashForUserBase(eventId, teamId, { signal, ...requestOptions });
...
export type GetGuildStashForUserBaseQueryResult = NonNullable<
  Awaited<ReturnType<typeof getGuildStashForUserBase>>
>;
export type GetGuildStashForUserBaseQueryError = unknown;

export function useGetGuildStashForUserBase<
  TData = Awaited<ReturnType<typeof getGuildStashForUserBase>>,
  TError = unknown,
>(
  eventId: number,
...
>(
  ...
  const queryOptions = getGetGuildStashForUserBaseQueryOptions(
    eventId,
    teamId,
    options,
  );
...
export const getGetGuildStashTabBaseQueryKey = (
  eventId: number,
  teamId: number,
  stashId: string,
) => {
  return [`/${eventId}/teams/${teamId}/guild-stash/${stashId}`] as const;
};

export const getGetGuildStashTabBaseQueryOptions = <
  TData = Awaited<ReturnType<typeof getGuildStashTabBase>>,
  TError = unknown,
>(
  eventId: number,
  teamId: number,
  ...
  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getGuildStashTabBase>>
  > = ({ signal }) =>
    getGuildStashTabBase(eventId, teamId, stashId, {
      signal,
      ...requestOptions,
    });
...
export type GetGuildStashTabBaseQueryResult = NonNullable<
  Awaited<ReturnType<typeof getGuildStashTabBase>>
>;
export type GetGuildStashTabBaseQueryError = unknown;

export function useGetGuildStashTabBase<
  TData = Awaited<ReturnType<typeof getGuildStashTabBase>>,
  TError = unknown,
>(
  eventId: number,
...
>(
  ...
  const queryOptions = getGetGuildStashTabBaseQueryOptions(
    eventId,
    teamId,
    stashId,
    options,
...
> => {
  ...
  > = (props) => {
    ...
    return switchStashFetchingBase(
      eventId,
      teamId,
      stashId,
      data,
...
export type SwitchStashFetchingBaseMutationResult = NonNullable<
  Awaited<ReturnType<typeof switchStashFetchingBase>>
>;
...
> => {
  return useMutation(
    getSwitchStashFetchingBaseMutationOptions(options),
    queryClient,
  );
};
/**
...
export type UpdateStashTabBaseMutationResult = NonNullable<
  Awaited<ReturnType<typeof updateStashTabBase>>
>;
...
> => {
  return useMutation(
    getUpdateStashTabBaseMutationOptions(options),
    queryClient,
  );
};
