...
export const getGetObjectiveTreeForEventBaseQueryKey = (eventId: number) => {
  return [`/events/${eventId}/objectives`] as const;
};

export const getGetObjectiveTreeForEventBaseQueryOptions = <
  TData = Awaited<ReturnType<typeof getObjectiveTreeForEventBase>>,
  TError = unknown,
>(
  eventId: number,
  options?: {
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetObjectiveTreeForEventBaseQueryKey(eventId);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getObjectiveTreeForEventBase>>
  > = ({ signal }) =>
    getObjectiveTreeForEventBase(eventId, { signal, ...requestOptions });
...
export type GetObjectiveTreeForEventBaseQueryResult = NonNullable<
  Awaited<ReturnType<typeof getObjectiveTreeForEventBase>>
>;
export type GetObjectiveTreeForEventBaseQueryError = unknown;

export function useGetObjectiveTreeForEventBase<
  TData = Awaited<ReturnType<typeof getObjectiveTreeForEventBase>>,
  TError = unknown,
>(
  eventId: number,
...
>(
  ...
  const queryOptions = getGetObjectiveTreeForEventBaseQueryOptions(
    eventId,
    options,
  );
...
export type CreateObjectiveBaseMutationResult = NonNullable<
  Awaited<ReturnType<typeof createObjectiveBase>>
>;
...
> => {
  return useMutation(
    getCreateObjectiveBaseMutationOptions(options),
    queryClient,
  );
};
/**
...
export const getGetValidMappingsBaseQueryKey = (eventId: number) => {
  return [`/events/${eventId}/objectives/valid-mappings`] as const;
};

export const getGetValidMappingsBaseQueryOptions = <
  TData = Awaited<ReturnType<typeof getValidMappingsBase>>,
  TError = unknown,
>(
  eventId: number,
  options?: {
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetValidMappingsBaseQueryKey(eventId);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getValidMappingsBase>>
  > = ({ signal }) =>
    getValidMappingsBase(eventId, { signal, ...requestOptions });
...
export type GetValidMappingsBaseQueryResult = NonNullable<
  Awaited<ReturnType<typeof getValidMappingsBase>>
>;
export type GetValidMappingsBaseQueryError = unknown;

export function useGetValidMappingsBase<
  TData = Awaited<ReturnType<typeof getValidMappingsBase>>,
  TError = unknown,
>(
  eventId: number,
...
export const getGetObjectiveValidationsBaseQueryKey = (eventId: number) => {
  return [`/events/${eventId}/objectives/validations`] as const;
};

export const getGetObjectiveValidationsBaseQueryOptions = <
  TData = Awaited<ReturnType<typeof getObjectiveValidationsBase>>,
  TError = unknown,
>(
  eventId: number,
  options?: {
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetObjectiveValidationsBaseQueryKey(eventId);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getObjectiveValidationsBase>>
  > = ({ signal }) =>
    getObjectiveValidationsBase(eventId, { signal, ...requestOptions });
...
export type GetObjectiveValidationsBaseQueryResult = NonNullable<
  Awaited<ReturnType<typeof getObjectiveValidationsBase>>
>;
export type GetObjectiveValidationsBaseQueryError = unknown;

export function useGetObjectiveValidationsBase<
  TData = Awaited<ReturnType<typeof getObjectiveValidationsBase>>,
  TError = unknown,
>(
  eventId: number,
...
>(
  ...
  const queryOptions = getGetObjectiveValidationsBaseQueryOptions(
    eventId,
    options,
  );
...
export type ValidateObjectivesBaseMutationResult = NonNullable<
  Awaited<ReturnType<typeof validateObjectivesBase>>
>;
...
> => {
  return useMutation(
    getValidateObjectivesBaseMutationOptions(options),
    queryClient,
  );
};
/**
...
export type DeleteObjectiveBaseMutationResult = NonNullable<
  Awaited<ReturnType<typeof deleteObjectiveBase>>
>;
...
> => {
  return useMutation(
    getDeleteObjectiveBaseMutationOptions(options),
    queryClient,
  );
};
/**
...
export const getGetObjectiveBaseQueryKey = (eventId: number, id: number) => {
  return [`/events/${eventId}/objectives/${id}`] as const;
};

export const getGetObjectiveBaseQueryOptions = <
  TData = Awaited<ReturnType<typeof getObjectiveBase>>,
  TError = unknown,
>(
  eventId: number,
  id: number,
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetObjectiveBaseQueryKey(eventId, id);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getObjectiveBase>>
  > = ({ signal }) =>
    getObjectiveBase(eventId, id, { signal, ...requestOptions });
...
export type GetObjectiveBaseQueryResult = NonNullable<
  Awaited<ReturnType<typeof getObjectiveBase>>
>;
export type GetObjectiveBaseQueryError = unknown;

export function useGetObjectiveBase<
  TData = Awaited<ReturnType<typeof getObjectiveBase>>,
  TError = unknown,
>(
  eventId: number,
