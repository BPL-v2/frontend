...
import type { TwitchStream } from "../models";
...
export const getGetStreamsBaseQueryKey = (eventId: number) => {
  return [`/events/${eventId}/streams`] as const;
};

export const getGetStreamsBaseQueryOptions = <
  TData = Awaited<ReturnType<typeof getStreamsBase>>,
  TError = unknown,
>(
  eventId: number,
  options?: {
    query?: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof getStreamsBase>>, TError, TData>
    >;
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getStreamsBase>>> = ({
    signal,
  }) => getStreamsBase(eventId, { signal, ...requestOptions });
...
export type GetStreamsBaseQueryResult = NonNullable<
  Awaited<ReturnType<typeof getStreamsBase>>
>;
export type GetStreamsBaseQueryError = unknown;

export function useGetStreamsBase<
  TData = Awaited<ReturnType<typeof getStreamsBase>>,
  TError = unknown,
>(
  eventId: number,
