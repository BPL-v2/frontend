// Active skill gems only (no auras, no support gems), sourced from
// https://poedb.tw/us/Skill_Gems. Transfigured ("of X") variants are listed
// as separate entries from their base gem, since they play very differently.
