...
const DivinationCards = (styles: IconProps[]) => `
  <g style=${toString(styles[0])} stroke-width="1.34" >
    <path stroke-width="5" d="m37 133 86 51 75-108-85-31Z"/>
    <path d="M108 141c-5 6 9 2 2-1m8 19c-7-4 7-6 4 2s-15-5-6-9c9-3 14 8 7 14s-17-3-15-10 9-9 15-7 8 12 6 18-6 6-10 7m37-106c-8 5 9 1 2-3s-10 9-9 11c2 2 0-1 0-1M88 90c-4 5 11 4 5-3s-17 9-6 11c10 2 13-10 15-17q4-10 15-9t22 1c11 0 4-11-2-15s-12 10-3 8c8-1-1-9-2-2m-78 65c-5 4 4 7 4-1s-15-4-10 4q8 11 21 6c8-2 9 13 3 12-7-1-1-7 2-5m-2-43c-10 5-9 22-2 29s17 5 24 9q11 4 11 14-5 11-17 5c-12-6 1-16 7-12s-1 10-5 5m16-25c-8 0 5-9 6 0s-9 13-12 4 2-17-5-24-22-1-25 8 7 17 14 13 11-11 6-16-14 10-8 12 4-5 1-7m71-7c-3 9 12 2 5-3s-17 6-9 12 19-5 16-12m-23-24c-6-8-15-5-24-5s-17 11-17 21 10 15 18 16c8 0 18-2 23 4q6 12-3 20c-9 8-13 10-21 5-7-5-4-15 3-19s18 6 11 11-11 0-9-4q5-5 5 0m-1-36c11-1-1-12-7-7s-2 14 6 13 19-5 12-14c-7-8-27-4-30 7s8 13 16 12q14 0 20-10c6-10 4-15 12-18s17-8 25-2c7 5 0 16-6 19s-15 7-20 1 1-12 6-16c5-3 15-3 16 4 0 7-14 12-16 5-2-6 8-4 5 0" style="fill:none;stroke-width:2"/>
...
const Allflame = (styles: IconProps[]) => `
    <g transform="translate(-50.492 -69.383)scale(1.23901)"
        style=${toString(styles[0])} stroke-width="1.61">
        <path d="M100.056 197.813q-69.94-61.173 0-120.16h49.674c46.288 37.588 46.22 79.913 0 120.16z" />
        <path
            d="M139.14 152.667a21.631 22.285 0 0 1-30.578.827 21.631 22.285 0 0 1-.807-31.503 21.631 22.285 0 0 1 30.578-.836 21.631 22.285 0 0 1 .815 31.503"
            fill="none" />
        <path
            d="M133.93 147.687a14.536 15.184 0 0 1-20.55.563 14.536 15.184 0 0 1-.541-21.464 14.536 15.184 0 0 1 20.548-.57 14.536 15.184 0 0 1 .548 21.464"
            style="fill:#fcf400;stroke:none" />
        <path d="M114.993 77.653c-28.961 39.336-31.32 80.355-.442 120.16h-7.424c-26.856-34.89-33.16-74.454.176-120.16z"
            fill="none" />
        <path d="M107.127 197.813h-9.944q-1.944 8.286 0 15.336 28.373 6.54 54.8 0c.663-5.112 1.19-10.224 0-15.336z" />
        <path d="M96.498 209.869c18.717 3.467 37.393 5.397 55.877 0m-56.099-6.085q29.09 5.214 56.41 0" fill="none" />
        <path
            d="M100.056 197.813q-1.354 6.654-.789 12.557l-2.769-.501q-.786-6.143.685-12.056zm51.928 0h-2.961a32.8 32.8 0 0 1-.03 12.962l3.333-.892q.891-6.165-.342-12.07m-38.007.089v14.585l2.616.25v-14.924zm17.413-.089h2.253v15.237q-1.434.085-2.823.13v-15.367z" />
        <path d="M133.201 77.653c28.962 39.336 31.32 80.355.442 120.16h7.425c26.856-34.89 33.16-74.454-.177-120.16z"
            fill="none" />
        <path
            d="M107.303 77.653H90.75c-1.4-2.842-1.4-4.435 0-7.653 21.293-1.414 43.293-1.29 66 .125 1.107 2.948 1.107 4.9 0 7.48z" />
        <path
            d="M98.465 69.556q.265-4.037 3.49-6.746 21.066-2.001 43.133 0 3.423 2.75 3.845 6.75-19.61-1.223-50.468-.004" />
        <path
            d="M109.016 62.253q-.157-2.517 1.984-4.503 11.595-1.503 24.25 0 1.827 1.344 1.71 4.457c-9.39-.685-18.672-.359-27.944.046m10.22 27.152c2.99.352 5.98.47 8.971 0V66.512c-2.939-.596-5.959-.46-9.015 0z" />
        <path
            d="M120.74 66.308q-2.323-2.676-5.884-4.29l17.187-.045c-1.88 1.169-3.92 2.614-5.238 4.31a25.7 25.7 0 0 0-6.065.025" />
        <path
...
export const iconMap: Record<string, (props: IconProps[]) => string> = {
  ...
  "Incarnations of Fear & Neglect": Memories,
  Allflame: Allflame,
